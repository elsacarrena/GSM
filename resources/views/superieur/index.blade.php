                    ...
                    <tbody>
                        @foreach ($profils as $profil)
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group"> <a href="{{ route('superieur.edit', $profil->id) }}" class="btn btn-primary btn-sm">Modifier</a>

                                        <form action="{{ route('superieur.profilDestroy', $profil->id) }}" method="POST" style="display: inline;" onsubmit="return confirmDelete()">
                                            @csrf
                                            @method('DELETE')
