    ...
    <div class="content">
        ...
        <div class="presentation">
            ...
            <div class ="notre-equipe">
                <p>1-Fawaz ADJIBADE : CEO<br><br> 2-François ATCHIMAVO : Manager Général<br><br>3-Modéran AKITIKPA : Chef Service Production & Réalisation<br>4-Boris AKAN : Chef Service Média<br>5-FITILA Ravilia : Chef Service Informatique<br>6-AHLONSOU Sylvestre : Développeur Front-End<br><br>7-SITONDJI Ange : Développeur Back-End</p>
            </div>
        </div>
    </div>
@endsection
