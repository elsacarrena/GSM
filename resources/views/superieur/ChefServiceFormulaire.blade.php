    ...
    <div class="justify-content-center">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{route('superieur.ModifChefservice') }}" method="POST">
                    @csrf
                    ...
                    <a href="{{ route('superieur.IndexChefservice') }}" class="btn btn-danger">Revenir a la liste des chefs de service</a>
                </form>
            </div>
        </div>
    </div>
