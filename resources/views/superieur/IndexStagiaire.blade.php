    ...
    <div class="justify-content-center">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a href="{{ route('superieur.StagiaireFormulaire') }}" class="btn btn-primary">Ajouter un stagiaire</a>
                @if (session('success'))
                    ...
                    <tbody>
                        @foreach ($stagiaires as $stagiaires)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('superieur.ModifStagiaire', $stagiaires) }}" class="btn btn-primary btn-sm">Modifier un stagiaire</a>
                                    <form action="{{ route('superieur.destroyStagiaire', $stagiaires ->id) }}" method="POST" style="display: inline;" onsubmit="return confirmDelete()">
                                        @csrf
                                        @method('DELETE')
