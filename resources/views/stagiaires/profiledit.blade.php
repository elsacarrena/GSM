...
<div class="container">
    ...
    <form action="{{ route('stagiaires.profilUpdate',  $profil->id) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="situation_matrimoniale" id="situation_matrimoniale" class="form-control" value="{{ $profil->situation_matrimoniale }}" required>
        </div>
        ...
        <button type="submit" class="btn btn-primary">Modifier un stagiaire</button>
    </form>
</div>
@endsection
