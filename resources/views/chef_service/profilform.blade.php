...
<div class="container">
    ...
    <div class="justify-content-center">
        <div class="card">
            <div class="card-header">Ajouter un nouveau profil de chef service</div>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('chef_service.profilStore') }}" method="POST">
                    ...
                    <br>
                    <button type="submit" class="btn btn-primary">Ajouter un profil dun chef service</button>
                    <a href="{{ route('chef_service.profilListe') }}" class="btn btn-danger">Revenir à la liste des profils des chefs services</a>
