    ...
    <div class="justify-content-center">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{route('chef_service.storeAppreciation') }}" method="POST">
                    @csrf
                    ...
                    <a href="{{ route('chef_service.index_appreciation') }}" class="btn btn-danger">Revenir a la liste des appréciations</a>
                </form>
            </div>
        </div>
    </div>
