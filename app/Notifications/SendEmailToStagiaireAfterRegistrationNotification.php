...
class SendEmailToStagiaireAfterRegistrationNotification extends Notification
{
    use Queueable;
    public $code;
    public $email;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        ->subject('Création de compte stagiaire')
        ->line('Bonjour')
        ...
        ->action('Cliquez ici', url('/validation-account' . '/' . $this->email))
